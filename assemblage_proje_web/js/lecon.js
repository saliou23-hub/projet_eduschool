...
if (!contenus) {
  ...
  if (cours) {
    ...
    else if (titreNorm.includes("structure atomique")) {quizFile = "quiz_structure_atomique.html"; idLecon ="structure";}
    else if (titreNorm.includes("reactions")) { quizFile = "quiz_reactions.html"; idLecon ="reactions";}
